...
my_name = "--SUJAL--"
CHANNEL_ID = "-1002618428217"##change it with your channel 🆔 
...
async def root_route_handler(request):
    return web.json_response("https://txt-to-video-ug2v.onrender.com") ## change it with your host url
...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... 😜 𝕊𝕖𝕔𝕣𝕖𝕥 ℂ𝕠𝕞𝕞𝕒𝕟𝕕𝕤 𝔸𝕣𝕖 ℂ𝕝𝕒𝕤𝕤𝕚𝕗𝕚𝕖𝕕 — 𝕆𝕟𝕝𝕪 𝔽𝕠𝕣 𝕊𝕦𝕛𝕒𝕝'𝕤 𝔼𝕪𝕖𝕤 🔐😎**Bot Made By 🅂🅄🅅🄹🄰🄻 💻**🔍\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @youcndoitbro {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @youcndoitbro.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
